    ...
    PhoneAuthCredential phoneAuthCredential) async {
      ...
      try {
        ...
        if(authCredential?.user != null){
          Navigator.push(context, MaterialPageRoute(builder: (context)=>Pgone()));
        }
                  ...
                  children: <Widget>[
                    Column(
                      children: <Widget>[
                        ...
                        FadeAnimation(1, Text("Mobile Number Valitaion", style: TextStyle(
                          fontSize: 30,
    ...
    child: Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Column(
            children: <Widget>[
              FadeAnimation(1, Text("OTP valitation", style: TextStyle(
                fontSize: 30,
                fontWeight: FontWeight.bold
              ),)),
              SizedBox(height: 20,),
              FadeAnimation(1.2, Text("Create an account, Enter the OTP", style: TextStyle(
                fontSize: 15,
          ...
          Column(
            children: <Widget>[
              ...
              FadeAnimation(1.4, makeInput(label: "OTP Number", obscureText: true)),
            ],
          ),
          FadeAnimation(1.5, Container(
            ...
            child: MaterialButton(
              ...
              child: Text("Verfied", style: TextStyle(
                fontWeight: FontWeight.w600, 
                fontSize: 18
              ),),
            ),
