...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _mapController(GoogleMapController controller) async{
    ...
    setState(() {
      ...
      _marker.add(Marker(markerId: MarkerId("id-1"),
      position: latLng,
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: IconButton(onPressed: () async{
                          ...
                          icon: Icon(Icons.pin_drop_rounded,color: Color(0XFF00B686),),
                          iconSize: 40.0,
                        )
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_address != null) 
                              Text(_address,style: Theme.of(context).textTheme.bodyText1,)
  ...
  _getAddress() async{
    Position _position = await Geolocator.getCurrentPosition(desiredAccuracy: LocationAccuracy.high);
    try {
     var  p = await placemarkFromCoordinates(_position.latitude,_position.longitude);
